...
public class CommonSettings {
	 ...
	 * @param testMgmt
	 */
	public CommonSettings(String projectName, String appType, String appEnviornment, String htmlReport, String xlsReport, String testLogs, String defectMgmt, String testMgmt) {
		super();
	...
	public void setIosID(String Realdevice) {
	...
	public void setRealDevice(String iosID) {
		this.iosID = iosID;
	}

	public String getIosBrowser() {
		return iosBrowser;
	}

	public void setIosBrowser(String iosBrowser) {
		this.iosBrowser = iosBrowser;
	}
