...
import step_definitions.MobileTests;

public class AndriodConstants extends MobileKeywords{
	public static class Orwell {

	
		public static  By login = By.xpath("//*[@resource-id='com.orwellg.white.label.dev:id/landing_login_button']");
		public static  By username = By.xpath("//android.widget.EditText[@resource-id='com.orwellg.white.label.dev:id/onBoarding_entryField_editText']");
        public static  By password = By.xpath("//android.widget.EditText[@resource-id='com.orwellg.white.label.dev:id/onBoarding_entryField_editText']");
